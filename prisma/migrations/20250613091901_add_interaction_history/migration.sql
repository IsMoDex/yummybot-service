...
CREATE TABLE "RecipeTranslation" (
    ...
    "description" TEXT,
    "steps" TEXT,
    CONSTRAINT "RecipeTranslation_recipeId_fkey" FOREIGN KEY ("recipeId") REFERENCES "Recipe" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "InteractionHistory_userId_createdAt_idx" ON "InteractionHistory"("userId", "createdAt");
